...
function SignUp() {
  ...
  const createUser=(e)=>{
    ...
    axios.post('http://localhost:10000/register',user)
          .then(res => {
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h1 className="h1">Ghana Institute of Architects 2023 Design Competition </h1>
              </div>
              ...
              <div className="max-w-sm mx-auto">
                ...
                <form onSubmit={(e)=>createUser(e)}>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="telephone">Work Telephone<span className="text-red-600">*</span></label>
                      <input id="telephone" type="tel" className="form-input w-full text-gray-300" placeholder="xxx-xxx-xxxx" required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                  ...
                  <div className="text-sm text-gray-500 text-center">
                    I agree to be contacted by Institute <Link to="#" className="underline text-gray-400 hover:text-gray-200 hover:no-underline transition duration-150 ease-in-out">Privacy Policy</Link>.
                                </div>
